...
type StudentServiceClient interface {
	...
	GetStudentByName(ctx context.Context, in *SearchByName, opts ...grpc.CallOption) (*Student, error)
}
...
func (c *studentServiceClient) GetStudentByName(ctx context.Context, in *SearchByName, opts ...grpc.CallOption) (*Student, error) {
	out := new(Student)
	err := c.cc.Invoke(ctx, "/StudentService/GetStudentByName", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StudentServiceServer interface {
	...
	GetStudentByName(context.Context, *SearchByName) (*Student, error)
...
func (UnimplementedStudentServiceServer) GetStudentByName(context.Context, *SearchByName) (*Student, error) {
...
func _StudentService_GetStudentByName_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/StudentService/GetStudentByName",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StudentServiceServer).GetStudentByName(ctx, req.(*SearchByName))
	}
	return interceptor(ctx, in, info, handler)
}
